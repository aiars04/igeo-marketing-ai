    ...
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[360px]">
        ...
        <form onSubmit={handleLogin} className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 space-y-4">
          ...
          {error && (
            <div className="flex items-center gap-2 text-[12px] text-rose-400 bg-rose-400/10 border border-rose-400/20 rounded-lg px-3 py-2">
              <AlertCircle size={13} />
              {error}
            </div>
          )}
          ...
          <button
            ...
            className="w-full bg-[var(--accent)] text-black font-semibold text-[13px] py-2.5 rounded-lg hover:opacity-90 disabled:opacity-50 transition-opacity"
          >
