      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <div className="card animate-fade-up">
            ...
            <div className="space-y-2">
              {[
                { name: 'Adrián Ruiz', role: 'Superadmin', bg: 'var(--accent)' },
                { name: 'Silvia',      role: 'Aprobador',  bg: 'var(--green)'  },
                { name: 'Ramón',       role: 'Editor',     bg: 'var(--amber)'  },
              ].map(u => (
                <div
                  key={u.name}
                  className="settings-item"
                ...
                >
                  <div
                    ...
                    style={{ background: u.bg, color: '#ffffff' }}
                  >
                    {u.name.charAt(0)}
                  </div>
